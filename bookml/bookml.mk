...
check-for-update:
	@$(if $(call ver.lt,v0.14.0,$(BOOKML_VERSION)),$(call bml.echo,$(bml.yellow)BookML update $(BOOKML_VERSION) available$(bml.comma) run `update` to install it))
...
detect-bookml:
	@$(call bml.testver,       BookML,,,v0.14.0)
detect-tex:
